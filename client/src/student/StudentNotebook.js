  ...
  return (
    <div className="container mx-auto p-2 sm:p-4 md:p-6 ">
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="tab w-full sm:w-1/4 text-center py-2 bg-textGround rounded-t-lg sm:rounded-l-t-lg sm:rounded-r-none border border-b-0">Reading</div>
      ...
      {/* Tab Content */}
      <div className="bg-textGround p-2 sm:p-4 md:p-6 rounded-b-lg border border-t-0">
