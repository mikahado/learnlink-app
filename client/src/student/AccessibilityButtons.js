...
function AccessibilityButtons({ showImages, onShowImagesToggle }) {
    ...
    return (
        <div className="flex flex-row md:flex-col justify-center space-y-2 md:space-y-4 items-center space-x-2 md:space-x-0">
            ...
            <button onClick={handleShowImagesToggle} className="w-24 h-24 flex flex-col justify-center items-center rounded-lg bg-textGround text-buttonTextGreen">
